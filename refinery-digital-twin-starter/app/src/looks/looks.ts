...
export interface DesertEnvironment {
  ...
  terrain: { size: number; segments: number; tileMetres: number; height: number; color: string; pad: string; normalScale: number };
...
export const looks: Record<LookId, Look> = {
  ...
  photoreal: { ...engineering, id: 'photoreal', label: 'Photoreal',
    ...
    environment: { ...engineering.environment, background: '#a9c9df', grid: false, room: false, intensity: 0,
      desert: { assets: { sky: 'assets/env/sky.hdr', color: 'assets/env/sand-color.webp', normal: 'assets/env/sand-normal.webp', roughness: 'assets/env/sand-rough.webp', context: 'assets/env/context.glb' }, terrain: { size: 4200, segments: 160, tileMetres: 11, height: 4.5, color: '#e1ccb0', pad: '#aaa18e', normalScale: .24 }, fog: { color: '#c8d4d5', near: 550, far: 3400 }, mountains: { radius: 650, height: 180, color: '#74634f' }, intensity: .65, backgroundIntensity: .85, rotation: 0 },

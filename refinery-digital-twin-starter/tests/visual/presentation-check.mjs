...
const output=resolve(root,task?`docs/handbacks/evidence/stageC-task-${task}/loading-mobile`:loading?'docs/handbacks/evidence/stageB-task-09/loading-mobile':'docs/handbacks/evidence/stageB-task-08');await mkdir(output,{recursive:true});
